...
1. **ATTENTION!** Make sure your repository is **PRIVATE** and **you have sent an invitation** to teacher's GitHub account - https://github.com/pkaferle. Otherwise, **if it isn't PRIVATE the final grade will be reduced to 0**.
